...
export const zoneActions = (
  ...
  server.registerTool(
    "gtm_zone",
    {
      description: `Performs various zone operations including create, get, list, update, remove, and revert actions. The 'list' action returns up to ${ITEMS_PER_PAGE} items per page.`,
