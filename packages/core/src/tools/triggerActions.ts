...
export const triggerActions = (
  ...
  server.registerTool(
    "gtm_trigger",
    {
      description: `Performs all GTM trigger operations: create, get, list, update, remove, revert. The 'list' action returns up to ${ITEMS_PER_PAGE} items per page.`,
      inputSchema: z.object({
        ...
        containerId: z
          .string()
          .describe(
            "The unique ID of the GTM Container containing the trigger.",
          ),
        workspaceId: z
          .string()
          .describe(
            "The unique ID of the GTM Workspace containing the trigger.",
          ),
        triggerId: z
          .string()
          .optional()
